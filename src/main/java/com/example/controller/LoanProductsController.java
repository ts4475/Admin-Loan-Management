...
public class LoanProductsController {
    ...
    public LoanProductsController(LoanProductsService loanProductsService) {
    ...
    public ResponseEntity<List<LoanProducts>> getLoanProductsByVendorId(@PathVariable Long vendorId) {
        List<LoanProducts> loanProducts = loanProductsService.findByVendorId(vendorId);
        return ResponseEntity.ok(loanProducts);
    }
    
    @GetMapping("/{productId}/details")
    public ResponseEntity<LoanProductDetailsDTO> getLoanProductDetails(@PathVariable Long productId) {
